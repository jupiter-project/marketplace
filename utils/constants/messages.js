...
const MESSAGES = Object.freeze({
  ...
  SET_ACCOUNT_SUCCESS: 'Your updated account info has been submitted to the blockchain and will be confirmed in ~15 seconds.',
  IMAGE_NOT_FOUND: 'Please upload your file first.',
  CREATE_NFT_SUCCESS: 'Your NFT has been created.Your NFT creation is successfully submitted to the blockchain. After ~15 seconds it will appear in your MY NFTS tab. From there, you can put it for sale on the marketplace.',
  ...
  PURCHASE_NFT_SUCCESS: 'Your buy order has been submitted to the blockchain and will be confirmed in ~15 seconds.',
  PURCHASE_NFT_ERROR: 'You don\'t have enough JUP to buy this NFT, please fund your account.',
  BID_NFT_SUCCESS: 'Your bid has been submitted to the blockchain and will be confirmed in ~15 seconds.',
  BID_NFT_ERROR: 'You don\'t have enough JUP to place this bid, please lower your bid price or fund your account.',
  CANCEL_NFT_ORDER_SUCCESS: 'Your order cancellation has been submitted to the blockchain and will be confirmed in ~15 seconds.',
  CANCEL_NFT_ORDER_ERROR: 'Incorrect passphrase, please try again.',
  DELETE_NFT_SUCCESS: 'Your NFT delete has been submitted to the blockchain and will be confirmed in ~15 seconds.',
